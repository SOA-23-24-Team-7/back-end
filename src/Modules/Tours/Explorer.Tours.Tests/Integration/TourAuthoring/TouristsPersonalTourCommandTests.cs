...
public class TouristsPersonalTourCommandTests : BaseToursIntegrationTest
{
    public TouristsPersonalTourCommandTests(ToursTestFactory factory) : base(factory) { }
    ...
    public void Creates()
    {
        ...
        var newEntity = new TouristsPersonalTourCreateDto
        {
            TouristId = 1,
        ...
        var result = ((ObjectResult)controller.Create(newEntity).Result)?.Value as TouristsPersonalTourResponseDto;
    ...
    public void Create_fails_invalid_data()
    {
        ...
        using var scope = Factory.Services.CreateScope();
        var controller = CreateController(scope);
        var updatedEntity = new TouristsPersonalTourCreateDto
        {
            Description = "Test"
        };
    ...
    public void Updates()
    {
        ...
        var controller = CreateController(scope);
        var dbContext = scope.ServiceProvider.GetRequiredService<ToursContext>();
        var updatedEntity = new TouristsPersonalTourUpdateDto
        {
            Id = -1,
            TouristId = 1,
            Name = "Tečnost",
            ...
            Status = TouristPersonalTourStatus.Draft,
            //Price = 0,
            //IsDeleted = false
        };

        // Act
        var result = ((ObjectResult)controller.Update(updatedEntity).Result)?.Value as TouristsPersonalTourResponseDto;
    ...
    public void Ready_succeeds()
    {
        ...
        var expectedStatus = TouristPersonalTourStatus.Ready;
    ...
    public void Publish_fails_invalid_keypoints()
    {
        ...
        var expectedStatus = TouristPersonalTourStatus.Draft;
        // Arrange - Controller and dbContext
        using var scope = Factory.Services.CreateScope();
        var controller = CreateController(scope);
        var dbContext = scope.ServiceProvider.GetRequiredService<ToursContext>();
    ...
    private static TouristsPersonalTourController CreateController(IServiceScope scope)
    {
        return new TouristsPersonalTourController(scope.ServiceProvider.GetRequiredService<ITouristsPersonalTourService>())
        {
